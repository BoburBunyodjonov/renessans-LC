...
export const MATERIALS: SeedMaterial[] = [
  // ---------- PDF ----------
  {
    ...
    fileUrl: '/demo/beginner-student-book.pdf',
    fileSize: 8_400_000,
    meta: { pages: 128 },
  ...
  },
  {
    ...
    level: 'BEGINNER',
    groupKey: 'work-books',
    fileUrl: '/demo/beginner-work-book.pdf',
    fileSize: 5_100_000,
    meta: { pages: 96 },
  ...
  },
  {
    ...
    level: 'ELEMENTARY',
    groupKey: 'student-books',
    fileUrl: '/demo/elementary-student-book.pdf',
    fileSize: 9_200_000,
    meta: { pages: 144 },
  ...
  },
  {
    ...
    level: 'ELEMENTARY',
    groupKey: 'work-books',
    fileUrl: '/demo/elementary-work-book.pdf',
    fileSize: 4_800_000,
    meta: { pages: 88 },
  ...
  },
  {
    ...
    groupKey: 'student-books',
    fileUrl: '/demo/pre-intermediate-student-book.pdf',
    fileSize: 10_300_000,
    meta: { pages: 152 },
  ...
  },
  {
    ...
    level: 'INTERMEDIATE',
    groupKey: 'student-books',
    fileUrl: '/demo/intermediate-student-book.pdf',
    fileSize: 11_700_000,
    meta: { pages: 168 },
    tags: ['intermediate'],
    downloadCount: 318,
  ...
  },
  {
    ...
    groupKey: 'work-books',
    fileUrl: '/demo/upper-intermediate-work-book.pdf',
    fileSize: 6_600_000,
    meta: { pages: 104 },
  ...
  },
  {
    ...
    level: 'IELTS',
    groupKey: 'student-books',
    fileUrl: '/demo/ielts-writing-templates.pdf',
    fileSize: 1_200_000,
    meta: { pages: 24 },
    tags: ['ielts', 'writing'],
    requireContact: true,
  ...
  },
  {
    ...
    level: 'IELTS',
    groupKey: 'student-books',
    fileUrl: '/demo/ielts-speaking-cue-cards.pdf',
    fileSize: 900_000,
    meta: { pages: 18 },
    tags: ['ielts', 'speaking'],
    requireContact: true,
  ...
  },
  {
    ...
    level: 'KIDS',
    groupKey: 'work-books',
    fileUrl: '/demo/kids-abc-workbook.pdf',
    fileSize: 3_400_000,
    meta: { pages: 60 },
    tags: ['kids', 'alphabet'],
    downloadCount: 522,
  ...
  // ---------- AUDIO ----------
  {
    ...
    fileUrl: '/demo/beginner-listening-01.wav',
    fileSize: 14_000_000,
  ...
  },
  {
    ...
    level: 'ELEMENTARY',
    groupKey: 'listening-practice',
    fileUrl: '/demo/elementary-dialogues.wav',
    fileSize: 18_500_000,
  ...
  },
  {
    ...
    level: 'IELTS',
    groupKey: 'listening-practice',
    fileUrl: '/demo/ielts-listening-test-1.wav',
    fileSize: 27_000_000,
  ...
  },
  {
    ...
    fileUrl: '/demo/pronunciation-44-sounds.wav',
    fileSize: 22_000_000,
